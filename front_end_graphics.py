...
def numberOfJobs():
    ...
    begin_label.pack(pady = 20)
    numberOfJobsSlider = customtkinter.CTkSlider(mainMenu, from_=0, to=100, command=jobsValue)
...
#createMainScreen() #intended order to run
#numberOfJobs()   
#arrivalBurstTimeInput()

#stuff works just adjust


#things to do: 
#save input for number of jobs
#work on saving the information in a tuple for burst time and arrvial
#create loop that reloads the burst/arrival time based on the number of jobs inputted
